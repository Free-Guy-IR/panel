...
import { Bell, Database, Fingerprint, ListChecks, ListTodo, LucideIcon, Palette, Send, Settings as SettingsIcon, ShieldAlert, Users, Webhook } from 'lucide-react'
...
const allTabs: Tab[] = [
  ...
  { id: 'connection-limit-violations', label: 'settings.connectionLimit.violations.navTitle', icon: ShieldAlert, url: '/settings/connection-limit/violations' },
