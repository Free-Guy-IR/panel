...
**🔐 پروتکل‌ها و امنیت**
- پشتیبانی از **Vmess**، **VLESS**، **Trojan**، **Shadowsocks**، **WireGuard**، **Hysteria2**، **OpenVPN** و **MTProto** (پروکسی تلگرام)
...
برای مدیریت همان نود، می‌تونی بقیه‌ی زیردستورها رو هم با همین پیشوند اجرا کنی (`node-eu-1 ...`).

> ⚠️ **مهم:** بین نودها پورت تکراری نگذار. پورت اتصال و پورت‌های هر هسته (Xray، sing-box، OpenVPN، MTProto و...) که به هر نود وصل می‌کنی باید برای هر نود کاملاً یکتا باشد.
