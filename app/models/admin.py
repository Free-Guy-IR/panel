...
class AdminDetails(AdminContactInfo):
    ...
    # None means every group is allowed; a list restricts this admin to those.
...
class AdminModify(BaseModel):
    ...
    permission_overrides: RoleLimits | None = None
    # Sending null clears the restriction; omitting the field leaves it alone.
    # update_admin tells those apart via model_fields_set.
    allowed_group_ids: list[int] | None = None
